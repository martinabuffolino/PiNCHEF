...
var appetizersRecipes: [Recipe] = [
    ...
    Recipe(title: "Tater Tots",
           ...
           instructions: [
                ...
                Step(type: "🔥", text: "Fry for 3-4 minutes."),
           ],
...
var first_cousesRecipes: [Recipe] = [
    ...
    Recipe(title: "Spaghetti with Tuna",
           ...
           instructions: [
                ...
                Step(type: "🔥", text: "Heat olive oil over medium heat."),
                Step(type: "🫳", text: "Add garlic and cook about 1 minute."),
                Step(type: "🫳", text: "Add cherry tomatoes and cook about 2 minutes."),
...
var second_coursesRecipes: [Recipe] = [
    Recipe(title: "Braised Steak",
           ...
           instructions: [
                ...
                Step(type: "🔥", text: "Cook the steak for 4-5 minutes then take out."),
                Step(type: "🔥", text: "Cook onion and garlic for 3-4 minutes."),
                Step(type: "🫳", text: "Add Worcestershire sauce, Dijon mustard, and fresh thyme sprigs."),
                Step(type: "🔥", text: "Let the steak simmer for 2-2.5 hours."),
           ],
    ...
    Recipe(title: "Vegan Cotoletta",
           ...
           instructions: [
                ...
                Step(type: "🔥", text: "Fry the seitan cutlets about 3-4 minutes"),
           ],
           imageName: "cotoletta",
...
var dessertsRecipes: [Recipe] = [
    ...
    Recipe(title: "Blueberry Muffins",
           ...
           instructions: [
                ...
                Step(type: "🔥", text: "Bake in the preheated oven for 18-20 minutes."),
           ],
           imageName: "muffin",
